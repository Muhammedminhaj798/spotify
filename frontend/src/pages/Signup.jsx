    ...
    <div className="min-h-screen bg-black flex flex-col items-center justify-center px-4">
      ...
      <div className="w-full max-w-md">
        ...
        <button
          ...
          disabled={loading}
          className={`w-full bg-green-500 hover:bg-green-400 text-black font-bold py-4 rounded-full text-lg mb-8 transition-colors ${loading ? "opacity-50 cursor-not-allowed" : ""
            }`}
        >
